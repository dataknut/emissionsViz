...
if(pg$value > 0){
  text <- paste0("In addition an estimated ", 
                 round(pg$value,2), 
...
data.table::fwrite(t, file = here::here("parish", "data", paste0(parish, "_totalTerritorialEmissions_CSEImpactTool.csv")))
```
...
data.table::fwrite(t, file = here::here("parish", "data", paste0(parish, "_totalConsumptionEmissions_CSEImpactTool.csv")))
